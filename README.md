# Blockchain-Based Identity Management System — README.md
...
* [API reference (core endpoints)](#api-reference-core-endpoints)
  ...
  * [`GET /issuer/public-key`](#get-issuerpublic-key)
* [Credential format & data model](#credential-format--data-model)
...
All endpoints accept/return JSON. Issuer/revoke endpoints require JWT auth.
...
3. Submit a PR with clear description and demo steps.
4. For contract changes, include updated Hardhat tests.
...
Open an issue or contact the primary author: **Shreyansh Rathaur**.
